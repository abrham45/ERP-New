...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Models.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Erp.Models.RegionBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("TotalRegionExternalCost")
                        .HasColumnType("float");

                    b.Property<double>("TotalRegionOverheadCosts")
                        .HasColumnType("float");

                    b.Property<double>("TotalRegionTimeCosts")
                        .HasColumnType("float");

                    b.Property<double>("TotalRegionZoneTotalCost")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("RegionPlanId");

                    b.ToTable("RegionBudget");
                });

            modelBuilder.Entity("Erp.Models.RegionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Erp.Models.Zone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Erp.Models.ZoneBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ZonePlanId")
                        .HasColumnType("int");

                    b.Property<double>("ZoneTotalCost")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("ZonePlanId");

                    b.ToTable("ZoneBudget");
                });

            modelBuilder.Entity("Erp.Models.ZonePlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Erp.Models.RegionBudget", b =>
                {
                    b.HasOne("Erp.Models.Region", "Region")
                        .WithMany()
                        .HasForeignKey("RegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Erp.Models.RegionPlan", "RegionPlan")
                        .WithMany()
                        .HasForeignKey("RegionPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Erp.Models.ZoneBudget", b =>
                {
                    b.HasOne("Erp.Models.Zone", "Zone")
                        .WithMany()
                        .HasForeignKey("ZoneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Erp.Models.ZonePlan", "ZonePlan")
                        .WithMany()
                        .HasForeignKey("ZonePlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
